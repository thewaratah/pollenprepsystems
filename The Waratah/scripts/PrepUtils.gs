 ...
 * Shared utility for resolving recipe names from linked records.
 * Waratah uses "Item Name" (linked record → Items table).
 * Sakura uses "Recipe Name" (plain text) — this function handles both.
 * ======================================================= */
