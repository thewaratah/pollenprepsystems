 ...
 *
 * Extracted from two identical nested functions:
 *   getSubRecipeRequirements() in createIngredientPrepDocFromTemplate_
 *   getSubRecipeReqs()         in createOrReplaceIngredientPrepDoc_
 * ======================================================= */
